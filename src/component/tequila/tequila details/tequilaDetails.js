...
const url="http://localhost:8210/tequiladetails";
class Details extends Component {
    ...
    orderId=[];
    proceed=()=>{
        let item=sessionStorage.setItem('tequila',this.state.details.product_id);
        ...
        this.props.history.push(`/tequilaplaceOrder/${this.state.details.name}`)
    }
