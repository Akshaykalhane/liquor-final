...
const url="http://localhost:8210/vodkadetails";
class Details extends Component {
    ...
    orderId=[];
    proceed=()=>{
        let item=sessionStorage.setItem('vodka',this.state.details.product_id);
        ...
        this.props.history.push(`/vodkaplaceOrder/${this.state.details.name}`)
    }
