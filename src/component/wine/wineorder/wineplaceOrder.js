...
const url="http://localhost:8210/wineItem";
...
class placeOrder extends Component{
    ...
    checkout=()=>{
        let obj=this.state;
        obj.productItem=sessionStorage.getItem('wine');
        fetch(postData,{
            method:'POST',
            headers:{
    ...
    componentDidMount(){
        ...
        let productItem=sessionStorage.getItem('wine');
        let orderId=[];
        ...
        console.log(this.props.match.params,'product name')
