            ...
            <Header />
              <div className="">
                    <div id="mainListing">
                        ...
                        <BeerListingDisplay cateData={this.state.cateList}/>
                    </div>
                 </div>
        </>
        )
