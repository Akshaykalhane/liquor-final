...
const url="http://localhost:8210/beerdetails";
class Details extends Component {
    ...
    orderId=[];
    proceed=()=>{
        let item=sessionStorage.setItem('beer',this.state.details.product_id);
        ...
        this.props.history.push(`/beerplaceOrder/${this.state.details.name}`)
    }
